...
constructor() {
    ...
    internal fun DegreesToRadians(inDegrees: Double): Double {
        return inDegrees * (Math.PI / 180)
    }


    internal fun HaversineFunction(inRadians: Double): Double {
        return (1 - Math.cos(inRadians)) / 2
    }


    internal fun Converge(inLonDifference: Double, inLat1: Double, inLat2: Double): VincentyConvergenceData {
    ...
    internal fun Converge(inData: VincentyConvergenceData, inLonDifference: Double, inLat1: Double, inLat2: Double, inAttempt: Int): VincentyConvergenceData {
        if (inAttempt >= 1000)
    ...
    internal fun CalculateDistance(inConvergenceData: VincentyConvergenceData): Double {
    ...
    internal fun LatLonDegreesToDistance(inLat1: Double, inLat2: Double, inLon1: Double, inLon2: Double): Double {
    ...
    internal fun LatLonRadiansToDistance(inLat1: Double, inLat2: Double, inLon1: Double, inLon2: Double): Double {
