...
constructor() {
    ...
    internal fun GetApparentTemperature(inTemp: Number?, inWindSpeed: Number?, inHumidity: Number?): Number? {
        if (inTemp == null)
            return null
    ...
    internal fun GetDewpoint(inTemperature: Number?, inHumidity: Number?): Number? {
    ...
    internal fun GetMSLPressure(inTemperature: Number, inStationPressure: Number?, inElevation: Number?): Number? {
