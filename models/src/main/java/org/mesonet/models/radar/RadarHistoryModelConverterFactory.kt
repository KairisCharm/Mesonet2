...
class RadarHistoryModelConverterFactory: Converter.Factory()
{
    companion object {
    ...
    {
        return RadarHistoryModelConverter()
    }


    class RadarHistoryModelConverter: Converter<ResponseBody, List<RadarImageInfo>> {
