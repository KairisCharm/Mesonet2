...
internal constructor() : MesonetDataCreator {
    override fun CreateMesonetData(inMesonetDataString: String): MesonetData? {
        var model = MesonetModel()

        val strFields = inMesonetDataString.split(",".toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()
        val fields = ArrayList(MesonetModel::class.declaredMemberProperties)
